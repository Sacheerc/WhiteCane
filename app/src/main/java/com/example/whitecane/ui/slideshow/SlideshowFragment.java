package com.example.whitecane.ui.slideshow;
...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        devicesList = (ListView) root.findViewById(R.id.devicesList);
        ...
        adapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_list_item_1, android.R.id.text1, scannedDeivcesList);
